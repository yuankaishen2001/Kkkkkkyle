  ...
  <main class="main-content">
    ...
    <section>
      <div class="academic-header">
        <h2>
          <FontAwesomeIcon :icon="faUser" style="color: #4fc08d"/>
          Introduction
        </h2>
      </div>
      <p style="line-height: 1.5;">
        ...
        I am excited to announce that I will be joining the <a href="https://www.hkust-gz.edu.cn" target="_blank" rel="noopener noreferrer">LARK@HKUST (GZ)</a> to pursue my Ph.D. in Computer Science under the supervision of Prof. <a href="https://cartus.github.io" target="_blank" rel="noopener noreferrer">Guo Zhijiang</a>.
      </p>
      <p style="line-height: 1.5;">
    ...
    <section>
      <div class="academic-header">
        <h2>
          <FontAwesomeIcon :icon="faGraduationCap" style="color: #4fc08d"/> Education
        </h2>
      </div>
      <div v-for="edu in education" :key="edu.program" class="academic-block">
        <img :src="edu.logo" :alt="edu.institution + ' Logo'" class="academic-logo">
        <div class="academic-content">
          <h3>{{ edu.institution }}</h3>
          <p>{{ edu.program }}</p>
          <p class="time">{{ edu.time }}</p>
          <div class="academic-tags" v-if="edu.tags">
            <span v-for="tag in edu.tags" :key="tag" class="academic-tag">{{ tag }}</span>
          </div>
        </div>
      </div>
    </section>
